...
class Metaclass_GoToPoint_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('bug2_interface')
        except ImportError:
            import logging
            import traceback
...
class GoToPoint_Request(metaclass=Metaclass_GoToPoint_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.move_switch = kwargs.get('move_switch', bool())
        from geometry_msgs.msg import Point
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.move_switch != other.move_switch:
            return False
    ...
    def move_switch(self):
        """Message field 'move_switch'."""
        return self._move_switch

    @move_switch.setter
    def move_switch(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'move_switch' field must be of type 'bool'"
        self._move_switch = value
...
class Metaclass_GoToPoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bug2_interface.srv import _go_to_point
...
class GoToPoint(metaclass=Metaclass_GoToPoint):
    from bug2_interface.srv._go_to_point import GoToPoint_Request as Request
    from bug2_interface.srv._go_to_point import GoToPoint_Response as Response
